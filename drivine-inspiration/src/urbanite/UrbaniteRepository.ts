...
export class UrbaniteRepository {
    ...
    constructor(
        ...
        @InjectCypher(__dirname, 'save-urbanite') readonly saveUrbanite: string
    ) {}

    //it is updated if the id is equal to existing node in graph database
    /**
